...
// const BASE_URL = "http://localhost:3011/api"; // Ganti jika beda host/port backend
const BASE_URL = "http://backend:3011/api"; // Ganti dengan nama service backend di Docker
